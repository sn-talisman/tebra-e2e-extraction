...
from extraction.extract_claim_encounters import extract_all_eras
...
OUTPUT_ROOT = os.path.abspath(os.path.join(os.path.dirname(__file__), '../data/output_all_practices'))
